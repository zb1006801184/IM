...
- (void)initBaseUI
{
    ...
    _MyButton.hidden = NO;
    [_MyButton setTitle:@"我的二维码" forState:UIControlStateNormal];
    _MyButton.frame = CGRectMake(0, 0, 100, 50);
    _MyButton.center = CGPointMake( Width / 2, Height - 100);
...
-(void)MyButtonClick {
    ...
    QRCodeShowViewController *QRShowVC = [[QRCodeShowViewController alloc] init];
    
    [self showViewController:QRShowVC sender:nil];
