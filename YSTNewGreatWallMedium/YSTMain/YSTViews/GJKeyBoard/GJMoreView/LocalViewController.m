...
#define kPading 10
@interface LocalViewController ()<BMKMapViewDelegate,BMKLocationServiceDelegate,BMKGeoCodeSearchDelegate,UITableViewDataSource,UITableViewDelegate>
{
...
-(void)addTopButton {
    ...
    UIBarButtonItem *rightBtn = [[UIBarButtonItem alloc] initWithTitle:@"发送" style:UIBarButtonItemStylePlain target:self action:@selector(rightBtnClick)];
...
-(void)rightBtnClick {
    ...
    CGRect frame = CGRectMake(self.mapView.center.x - 100, self.mapView.center.y - 80, 200, 160);
    
    UIImage *image = [self.mapView takeSnapshot:frame];
    
    UIViewController *VC = [[UIViewController alloc] init];
    
    UIImageView *imV = [[UIImageView alloc] initWithImage:image];
    imV.frame = CGRectMake(100, 300, 200, 100);
