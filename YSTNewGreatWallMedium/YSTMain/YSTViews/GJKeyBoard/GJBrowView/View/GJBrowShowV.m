...
@interface GJBrowShowV ()<UICollectionViewDelegate, UICollectionViewDataSource, UIGestureRecognizerDelegate>
...
- (GJEmotionControl *)pageControll
{
    if (_pageControll == nil) {
        
        _pageControll = [[GJEmotionControl alloc] initWithFrame:CGRectMake(0, _browShowCV.bottom, self.width, pageControllH)];
...
- (void)initializa
{
    ...
    _browShowCV.backgroundColor = rColor(237, 237, 246);
    ...
    [_browShowCV registerClass:[GJSysBrowCVCell class] forCellWithReuseIdentifier:@"GJSysBrowCVCell"];
    [_browShowCV registerClass:[GJAddBrowCVCell class] forCellWithReuseIdentifier:@"GJAddBrowCVCell"];
...
//    NSString *key = [emoDic allKeys][0];
    ...
    if (indexPath.section == 0 || indexPath.section == 1) {
        ...
        GJSysBrowCVCell *sysBrowCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GJSysBrowCVCell" forIndexPath:indexPath];
    ...
    GJAddBrowCVCell *addBrowCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"GJAddBrowCVCell" forIndexPath:indexPath];
